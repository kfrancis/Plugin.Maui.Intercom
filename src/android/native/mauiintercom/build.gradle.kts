...
dependencies {
    ...
    implementation ("io.intercom.android:intercom-sdk-base:18.9.4")
    ...
    // already vendors intercom-sdk-ui-18.9.4.aar, so declaring a runtime dependency here
    // would put the same classes in the graph twice.
    compileOnly ("io.intercom.android:intercom-sdk-ui:18.9.4")
}
